...
bool Graphics::Init() {
	...
	SCREEN_WIDTH = gScreenRect.w;
	SCREEN_HEIGHT = gScreenRect.h;
	...
	mWindow = SDL_CreateWindow(WINDOW_TITTLE, SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, gScreenRect.w, gScreenRect.h, SDL_WINDOW_SHOWN);
